...
public class Main {
    public static void main(String[] args) {
        ...
        Aquila aquila2 = new Aquila("fgfs", "etgtg", 34, LocalDate.of(2018, 6, 8), 36, 160, 44);
        for (var f : Animale.class.getDeclaredFields()) {
        ...
        System.out.println("L'animale più pesante è " + Animale.getPiuPesante(Specie.LEONE));
    }
}
